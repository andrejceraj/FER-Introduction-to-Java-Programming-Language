...
public class LinkedListIndexedCollection<T> implements List<T> {
	 ...
	 */
	private void setFirst(ListNode<T> newFirstNode) {
		first = newFirstNode;
	}
	 ...
	 */
	private void setLast(ListNode<T> newLastNode) {
		last = newLastNode;
	}
	...
	public void insert(T value, int index) {
		...
		if (index == size()) {
			...
			ListNode<T> currentNode = getNode(index), newNode = new ListNode<T>(value);
	...
	public int indexOf(Object value) {
		...
		ListNode<T> front = getFirst(), back = getLast();
	...
	public Object[] toArray() {
		...
		ListNode<T> currentNode = getFirst();
	...
	public ListNode<T> getNode(int index) {
		...
		if (index > size() / 2) {
			ListNode<T> currentNode = getLast();
	...
	public ElementsGetter<T> createElementsGetter() {
		return new LinkedListElementsGetter<T>(this, modificationCount);
	}
	...
	private static class LinkedListElementsGetter<T> implements ElementsGetter<T> {
		 ...
		 */
		private LinkedListIndexedCollection<T> linkedListIndexedCollection;
		/**
		 * List node of current position in the collection.
		 */
		private ListNode<T> currentListNode;
		/**
		 ...
		 */
		public LinkedListElementsGetter(LinkedListIndexedCollection<T> list, long modificationCount) {
		...
		public T getNextElement() {
			...
			ListNode<T> nodeToReturn = currentListNode;
		...
		public void forEachRemaining(Processor<? super T> processor) {
			ListNode<T> nodeToProcess = currentListNode;
	...
	static class ListNode<T> {
		 ...
		 */
		private void setprevious(ListNode<T> previous) {
