 ...
 * two sources of light that is be observed from multiple points of view.
 * Calculations are done using parallel threading
 * 
 * @author Andrej Ceraj
 *
 */
public class RayCasterParallel2 {
	...
	/**
	 * Creates an implementation of {@link IRayTracerAnimator}.
	 * 
	 * @return implementation of IRayTracerAnimator
	 */
