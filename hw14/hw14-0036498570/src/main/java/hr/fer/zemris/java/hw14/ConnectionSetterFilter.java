...
/**
 * Filter intercepting URLs starting with "/servleti/" to initialize connection
 * with the database and set it into servlet context.
 * 
 * @author Andrej Ceraj
 *
 */
@WebFilter(filterName = "connection-getter", urlPatterns = { "/servleti/*" })
